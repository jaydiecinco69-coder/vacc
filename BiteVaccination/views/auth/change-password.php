...
<head>
    ...
    <title>Change Password - Animal Bite Center Management System</title>
    ...
    <div class="max-w-md w-full space-y-8 p-8">
        <div class="bg-white rounded-lg shadow-xl p-8">
            <div class="text-center">
                ...
                <p class="mt-2 text-gray-600">Update your account password securely.</p>
            </div>
            ...
            <form class="mt-8 space-y-6" action="<?php echo BASE_URL; ?>auth/change-password" method="POST">
                <div>
        ...
        <div class="text-center text-white">
            <p class="text-sm">
                &copy; 2026 Animal Bite Center Management System
            </p>
        </div>
    </div>
</body>
